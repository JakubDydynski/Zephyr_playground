...
uintptr_t __irq_vector_table _irq_vector_table[96] = {
...
struct _isr_table_entry __sw_isr_table _sw_isr_table[96] = {
	{(const void *)0x43a0, (ISR)0x15b9}, /* 0 */
	{(const void *)0x43a0, (ISR)0x15e1}, /* 1 */
	{(const void *)0x43a0, (ISR)0x1609}, /* 2 */
	{(const void *)0x43a0, (ISR)0x1631}, /* 3 */
