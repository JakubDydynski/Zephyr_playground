...
MEMORY
    {
    FLASH (rx) : ORIGIN = (0x0 + 0x0), LENGTH = (2048 * 1024 - 0x0 - 0x0)
    RAM (wx) : ORIGIN = 0x20000000, LENGTH = (512 * 1K)
    OPTION_SETTING_OFS : ORIGIN = 16818432, LENGTH = 24 OPTION_SETTING_SAS : ORIGIN = 16818484, LENGTH = 204 OPTION_SETTING_S : ORIGIN = 16818688, LENGTH = 256
...
.fsp_dtc_vector_table (NOLOAD) : ALIGN_WITH_INPUT
{
...
.intList :
{
 ...
 KEEP(*(.gnu.attributes))
    ...
    OPTION_SETTING_OFS (NOLOAD) : { __OPTION_SETTING_OFS_start = .; KEEP(*(OPTION_SETTING_OFS)) KEEP(*(OPTION_SETTING_OFS.*)) __OPTION_SETTING_OFS_end = .; } > OPTION_SETTING_OFS __OPTION_SETTING_OFS_size = __OPTION_SETTING_OFS_end - __OPTION_SETTING_OFS_start; __OPTION_SETTING_OFS_load_start = LOADADDR(OPTION_SETTING_OFS); OPTION_SETTING_SAS (NOLOAD) : { __OPTION_SETTING_SAS_start = .; KEEP(*(OPTION_SETTING_SAS)) KEEP(*(OPTION_SETTING_SAS.*)) __OPTION_SETTING_SAS_end = .; } > OPTION_SETTING_SAS __OPTION_SETTING_SAS_size = __OPTION_SETTING_SAS_end - __OPTION_SETTING_SAS_start; __OPTION_SETTING_SAS_load_start = LOADADDR(OPTION_SETTING_SAS); OPTION_SETTING_S (NOLOAD) : { __OPTION_SETTING_S_start = .; KEEP(*(OPTION_SETTING_S)) KEEP(*(OPTION_SETTING_S.*)) __OPTION_SETTING_S_end = .; } > OPTION_SETTING_S __OPTION_SETTING_S_size = __OPTION_SETTING_S_end - __OPTION_SETTING_S_start; __OPTION_SETTING_S_load_start = LOADADDR(OPTION_SETTING_S);
.last_section :
{
  LONG(0xE015E015)
} > FLASH
